  ...
  return (
    <header
      className={mergeClasses(
        'sticky top-0 z-30 w-full border-b border-transparent bg-gray transition-all duration-300 max-md:border-gray-100',
        scrolled
          ? 'bg-gray/80 backdrop-blur-xl md:border-gray-100'
          : ''
      )}
    >
